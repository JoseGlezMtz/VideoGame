...
async function CreateChart() {
    try {
        const response = await fetch(`http://localhost:${port}/stats/characters_played`);
...
async function CreateChart2() {
    try {
        const response = await fetch(`http://localhost:${port}/stats/powerup_cards_played`);
        const data = await response.json();
...
async function CreateChart3() {
    try {
        const response = await fetch(`http://localhost:${port}/stats/Game`);
        const data = await response.json();
